...
class Client
{
    ...
    //授权地址
    public $OAUTH_AUTHORIZE_URL = '/cdp/auth/api/oauth/authorize?';
    //后台授权地址
    public $OAUTH_AUTHORIZE_URL_ADMIN = '/cdp/auth/admin/oauth/authorize?';
    ...
    public function __construct($options = [])
    {
        ...
        $this->OAUTH_AUTHORIZE_URL = $this->API_URL_PREFIX . $this->OAUTH_AUTHORIZE_URL;
        $this->OAUTH_AUTHORIZE_URL_ADMIN = $this->API_URL_PREFIX . $this->OAUTH_AUTHORIZE_URL_ADMIN;
